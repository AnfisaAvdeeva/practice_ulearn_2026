...
Система управления роботами, состоит из двух компонентов: интеллектуальной системы управления (AI) и исполнительного устройства (Device). AI генерирует команды, а Device их выполняет.
