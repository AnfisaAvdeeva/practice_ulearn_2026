...
Персонаж взаимодействует с объектами карты, которые могут иметь владельца, армию и сокровища. Метод Interaction.Make обрабатывает любые объекты через интерфейсы IOwnable, IHaveArmy и IHaveTreasure, проверяет возможность победы над армией, присваивает владельца и передает сокровища игроку.
