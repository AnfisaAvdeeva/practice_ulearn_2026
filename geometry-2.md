...
Рассматриваются геометрические тела в 3D: шар, параллелепипед, цилиндр и составное тело из коллекции частей. Над ними выполняются операции через классы-посетители, что позволяет добавлять новые операции без изменения классов фигур.
